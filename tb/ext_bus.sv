...
module ext_bus #(
  ...
  generate
    for (
      ...
      assign master_req[core_v_mini_mcu_pkg::DMA_READ_MASTER_IDXS[i]]  = heep_dma_read_req_i[i];
      assign master_req[core_v_mini_mcu_pkg::DMA_WRITE_MASTER_IDXS[i]] = heep_dma_write_req_i[i];
      assign master_req[core_v_mini_mcu_pkg::DMA_ADDR_MASTER_IDXS[i]]  = heep_dma_addr_req_i[i];
    end
  endgenerate
  ...
  generate
    for (
      ...
      assign heep_dma_read_resp_o[i]  = master_resp[core_v_mini_mcu_pkg::DMA_READ_MASTER_IDXS[i]];
      assign heep_dma_write_resp_o[i] = master_resp[core_v_mini_mcu_pkg::DMA_WRITE_MASTER_IDXS[i]];
      assign heep_dma_addr_resp_o[i]  = master_resp[core_v_mini_mcu_pkg::DMA_ADDR_MASTER_IDXS[i]];
    end
  endgenerate
