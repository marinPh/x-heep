...
def main():
    ...
    parser.add_argument(
        "--simulator-bin",
        help="Path to the pre-built simulator binary (e.g., ./Vtestharness). If provided, 'make run' is skipped.",
    )
    parser.add_argument(
        "--hex-dir",
        help="Directory where pre-compiled .hex files are located (used with --simulator-bin).",
    )
    parser.add_argument(
